...
public class Launcher {
    ...
    public static void main(final String... args) {
		...
		options.addOption(null, OPTION_CA_MITM, false,
				"Run as man in the middle using CA signed certificates, the CA keystore will be generated by default in user's home directory.");
        ...
        }else if(cmd.hasOption(OPTION_CA_MITM)){
			LOG.info("Running as Man in the Middle with self signed CA");
			bootstrap.withManInTheMiddle(new CASignedMitmManager());
        }
